#RODAR ESSE CÓDIGO PRIMEIRO, ELE RODAOS CODIGOS "leitura_dados_acao.R" "resumo_macro.R" E 
#"cod_agrup.R" NÃO RODAR ELES SEPARADAMENTE
...
colnames(atq1.A)[13] <- c("classif")
colnames(atq1.B)[13] <- c("classif")
colnames(atq2.A)[13] <- c("classif")
colnames(atq2.B)[13] <- c("classif")
colnames(atq3.A)[13] <- c("classif")
colnames(atq3.B)[13] <- c("classif")
colnames(atq4.A)[13] <- c("classif")
colnames(atq4.B)[13] <- c("classif")
colnames(atq5.A)[13] <- c("classif")
colnames(atq5.B)[13] <- c("classif")

colnames(def1.A)[13] <- c("classif")
colnames(def1.B)[13] <- c("classif")
colnames(def2.A)[13] <- c("classif")
colnames(def2.B)[13] <- c("classif")
colnames(def3.A)[13] <- c("classif")
colnames(def3.B)[13] <- c("classif")
colnames(def4.A)[13] <- c("classif")
colnames(def4.B)[13] <- c("classif")
colnames(def5.A)[13] <- c("classif")
colnames(def5.B)[13] <- c("classif")
