...
pairs(atq1.A[,4:11], pch=16, col=corg, cex=0.6, main = "Jogo 1 - Ataque Team A", oma=c(3,3,5,11),
      labels = c("Actions/Min","Centroid X","Centroid Y","Ball X","Ball Y","Dist. Run \nCentroid",
                 "Dist. Run \nBall","Area"))
par(xpd = TRUE)
legend("right",legend = c(levels(as.factor(atq1.A$classif))),  
       fill=cor5,cex = 0.5, pt.cex = 0.2, title = "Groups")
dev.off()


corg <- cor.des(cl_atq1B)
png('Desen.Grup_A1B.png', width=7*ppi, height=6*ppi, res=ppi)
pairs(atq1.B[,4:11], pch=16, col=corg, cex=0.6, main = "Match 1 - Offense Team B", oma=c(3,3,5,11),
      labels = c("Actions/Min","Centroid X","Centroid Y","Ball X","Ball Y","Dist. Run \nCentroid",
                 "Dist. Run \nBall","Area"))
par(xpd = TRUE)
...
pairs(atq2.A[,4:11], pch=16, col=corg, cex=0.6, main = "Match 2 - Offense Team A", oma=c(3,3,5,11),
      labels = c("Actions/Min","Centroid X","Centroid Y","Ball X","Ball Y","Dist. Run \nCentroid",
                 "Dist. Run \nBall","Area"))
par(xpd = TRUE)
...
pairs(atq2.B[,4:11], pch=16, col=corg, cex=0.6, main = "Match 2 - Offense Team B", oma=c(3,3,5,11),
      labels = c("Actions/Min","Centroid X","Centroid Y","Ball X","Ball Y","Dist. Run \nCentroid",
                 "Dist. Run \nBall","Area"))
par(xpd = TRUE)
...
pairs(atq3.A[,4:11], pch=16, col=corg, cex=0.6, main = "Match 3 - Offense Team A", oma=c(3,3,5,11),
      labels = c("Actions/Min","Centroid X","Centroid Y","Ball X","Ball Y","Dist. Run \nCentroid",
                 "Dist. Run \nBall","Area"))
par(xpd = TRUE)
...
pairs(atq3.B[,4:11], pch=16, col=corg, cex=0.6, main = "Match 3 - Offense Team B", oma=c(3,3,5,11),
      labels = c("Actions/Min","Centroid X","Centroid Y","Ball X","Ball Y","Dist. Run \nCentroid",
                 "Dist. Run \nBall","Area"))
par(xpd = TRUE)
...
pairs(atq4.A[,4:11], pch=16, col=corg, cex=0.6, main = "Match 4 - Offense Team A", oma=c(3,3,5,11),
      labels = c("Actions/Min","Centroid X","Centroid Y","Ball X","Ball Y","Dist. Run \nCentroid",
                 "Dist. Run \nBall","Area"))
par(xpd = TRUE)
...
pairs(atq4.B[,4:11], pch=16, col=corg, cex=0.6, main = "Match 4 - Offense Team B", oma=c(3,3,5,11),
      labels = c("Actions/Min","Centroid X","Centroid Y","Ball X","Ball Y","Dist. Run \nCentroid",
                 "Dist. Run \nBall","Area"))
par(xpd = TRUE)
...
pairs(atq5.A[,4:11], pch=16, col=corg, cex=0.6, main = "Match 5 - Offense Team A", oma=c(3,3,5,11),
      labels = c("Actions/Min","Centroid X","Centroid Y","Ball X","Ball Y","Dist. Run \nCentroid",
                 "Dist. Run \nBall","Area"))
par(xpd = TRUE)
...
pairs(atq5.B[,4:11], pch=16, col=corg, cex=0.6, main = "Match 5 - Offense Team B", oma=c(3,3,5,11),
      labels = c("Actions/Min","Centroid X","Centroid Y","Ball X","Ball Y","Dist. Run \nCentroid",
                 "Dist. Run \nBall","Area"))
par(xpd = TRUE)
...
pairs(def1.A[,5:11], pch=16, col=corg, cex=0.6, main = "Match 1 - Defence Team A", oma=c(3,3,5,11),
      labels = c("Centroid X","Centroid Y","Ball X","Ball Y","Dist. Run \nCentroid",
                 "Dist. Run \nBall","Area"))
par(xpd = TRUE)
...
pairs(def1.B[,5:11], pch=16, col=corg, cex=0.6, main = "Match 1 - Defence Team B", oma=c(3,3,5,11),
      labels = c("Centroid X","Centroid Y","Ball X","Ball Y","Dist. Run \nCentroid",
                 "Dist. Run \nBall","Area"))
par(xpd = TRUE)
...
pairs(def2.A[,5:11], pch=16, col=corg, cex=0.6, main = "Match 2 - Defence Team A", oma=c(3,3,5,11),
      labels = c("Centroid X","Centroid Y","Ball X","Ball Y","Dist. Run \nCentroid",
                 "Dist. Run \nBall","Area"))
par(xpd = TRUE)
...
pairs(def2.B[,5:11], pch=16, col=corg, cex=0.6, main = "Match 2 - Defence Team B", oma=c(3,3,5,11),
      labels = c("Centroid X","Centroid Y","Ball X","Ball Y","Dist. Run \nCentroid",
                 "Dist. Run \nBall","Area"))
par(xpd = TRUE)
...
pairs(def3.A[,5:11], pch=16, col=corg, cex=0.6, main = "Match 3 - Defence Team A", oma=c(3,3,5,11),
      labels = c("Centroid X","Centroid Y","Ball X","Ball Y","Dist. Run \nCentroid",
                 "Dist. Run \nBall","Area"))
par(xpd = TRUE)
...
pairs(def3.B[,5:11], pch=16, col=corg, cex=0.6, main = "Match 3 - Defence Team B", oma=c(3,3,5,11),
      labels = c("Centroid X","Centroid Y","Ball X","Ball Y","Dist. Run \nCentroid",
                 "Dist. Run \nBall","Area"))
par(xpd = TRUE)
...
pairs(def4.A[,5:11], pch=16, col=corg, cex=0.6, main = "Match 4 - Defence Team A", oma=c(3,3,5,11),
      labels = c("Centroid X","Centroid Y","Ball X","Ball Y","Dist. Run \nCentroid",
                 "Dist. Run \nBall","Area"))
par(xpd = TRUE)
...
pairs(def4.B[,5:11], pch=16, col=corg, cex=0.6, main = "Match 4 - Defence Team B", oma=c(3,3,5,11),
      labels = c("Centroid X","Centroid Y","Ball X","Ball Y","Dist. Run \nCentroid",
                 "Dist. Run \nBall","Area"))
par(xpd = TRUE)
...
pairs(def5.A[,5:11], pch=16, col=corg, cex=0.6, main = "Match 5 - Defence Team A", oma=c(3,3,5,11),
      labels = c("Centroid X","Centroid Y","Ball X","Ball Y","Dist. Run \nCentroid",
                 "Dist. Run \nBall","Area"))
par(xpd = TRUE)
...
pairs(def5.B[,5:11], pch=16, col=corg, cex=0.6, main = "Match 5 - Defence Team B", oma=c(3,3,5,11),
      labels = c("Centroid X","Centroid Y","Ball X","Ball Y","Dist. Run \nCentroid",
                 "Dist. Run \nBall","Area"))
par(xpd = TRUE)
...
ggplot(atq1.A, aes(x = area.Atq,y = des.centAtq, color = as.factor(classif))) +
  ...
  ggtitle("Match 1 - Ataque Equipe A") +
...
ggplot(atq1.B, aes(x = area.Atq,y = des.bola, color = as.factor(classif))) +
  geom_point(pch = 16) +
  scale_color_manual(values= cor5) +
  ggtitle("Match 1 - Ataque Equipe B") +
...
png('Desen.Grup_D1B.png', width=7*ppi, height=6*ppi, res=ppi)
pairs(def1.B[,2:11], pch=16, col=corg, cex=0.6, main = "Match 1 - Defence Equipe B")
dev.off()

ggplot(def1.A, aes(x = area.Def,y = des.centDef, color = as.factor(classif))) +
  geom_point(pch = 16) +
  scale_color_manual(values= cor5) +
  ggtitle("Match 1 - Defesa Equipe A") +
  labs(x = "Área Média do Ataque (m²)", y = "Deslocamento do Centroide no Ataque (m)", color = "Grupo") +
  theme_bw() +
  theme(plot.title = element_text(hjust = 0.5))
...
ggplot(def1.B, aes(x = bolax,y = bolay, color = as.factor(classif))) +
  geom_point(pch = 16) +
  scale_color_manual(values= cor5) +
  ggtitle("Match 1 - Defesa Equipe B") +
...
ggplot(l.1B,aes(x = ataque,y = as.numeric(grupo), color = time)) +
  geom_line(linetype = "longdash") +
  geom_point() +
  ggtitle("Match 1 - Team B Offense vs Team A Defense") +
  labs(x = "Atack No.", y = "Group", color = "Team") +
  scale_color_manual(values= cor5) +
  theme_bw() +
  theme(plot.title = element_text(hjust = 0.5))
...
ggplot(l.2B,aes(x = ataque,y = as.numeric(grupo), color = time)) +
  geom_line(linetype = "longdash") +
  geom_point() +
  ggtitle("Match 2 - Team B Offense vs Team A Defense") +
  labs(x = "Atack No.", y = "Group", color = "Team") +
  scale_color_manual(values= cor5) +
  theme_bw() +
  theme(plot.title = element_text(hjust = 0.5))
...
ggplot(l.3B,aes(x = ataque,y = as.numeric(grupo), color = time)) +
  geom_line(linetype = "longdash") +
  geom_point() +
  ggtitle("Match 3 - Team B Offense vs Team A Defense") +
  labs(x = "Atack No.", y = "Group", color = "Team") +
  scale_color_manual(values= cor5) +
  theme_bw() +
  theme(plot.title = element_text(hjust = 0.5))
...
ggplot(l.4B,aes(x = ataque,y = as.numeric(grupo), color = time)) +
  geom_line(linetype = "longdash") +
  geom_point() +
  ggtitle("Match 4 - Team B Offense vs Team A Defense") +
  labs(x = "Atack No.", y = "Group", color = "Team") +
  scale_color_manual(values= cor5) +
  theme_bw() +
  theme(plot.title = element_text(hjust = 0.5))
...
ggplot(l.5B,aes(x = ataque,y = as.numeric(grupo), color = time)) +
  geom_line(linetype = "longdash") +
  geom_point() +
  ggtitle("Match 5 - Team B Offense vs Team A Defense") +
  labs(x = "Atack No.", y = "Group", color = "Team") +
  scale_color_manual(values= cor5) +
  theme_bw() +
  theme(plot.title = element_text(hjust = 0.5))
...
time <- c(rep("OFF A",nrow(jogo1.A)),rep("OFF B",nrow(jogo1.B)),rep("DEF A",nrow(jogo1.B)),
...
time <- c(rep("OFF A",nrow(jogo2.A)),rep("OFF B",nrow(jogo2.B)),rep("DEF A",nrow(jogo2.B)),
...
time <- c(rep("OFF A",nrow(jogo3.A)),rep("OFF B",nrow(jogo3.B)),rep("DEF A",nrow(jogo3.B)),
...
time <- c(rep("OFF A",nrow(jogo4.A)),rep("OFF B",nrow(jogo4.B)),rep("DEF A",nrow(jogo4.B)),
...
time <- c(rep("OFF A",nrow(jogo5.A)),rep("OFF B",nrow(jogo5.B)),rep("DEF A",nrow(jogo5.B)),
