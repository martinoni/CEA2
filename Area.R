...
png('~/Development/IME/cea2/CEA2/descritiva/area_poligono_fossa/j1.png',
...
legend(13, 2025, col = 'red', legend = 'TIME A', box.col = 'red', border = 'red', fill = 'red', cex = 1.2)
legend(13, 1835, col = 'blue', legend = 'TIME B', box.col = 'blue', border = 'blue', fill = 'blue', cex = 1.2)
dev.off()
...
jogo1ime <- read.delim("~/Development/IME/cea2/CEA2/jogo2acao.txt", header=TRUE)
jogo1ime <- na.omit(jogo1ime)
...
png('~/Development/IME/cea2/CEA2/descritiva/area_poligono_fossa/j2.png',
    width = 700, height = 448)
plot(AA~tempo, xlim = c(0, nrow(jogo1ime_escalado)), data = jogo1ime[1,], 
     col = 'red', lty=0, type = 'l', ylab = 'Área do Polígono',
     xlab = 'Tempo', ylim = c(400, 2000), 
...
legend(13, 1835, col = 'red', legend = 'TIME A', box.col = 'red', border = 'red', fill = 'red', cex = 1.2)
legend(13, 1645, col = 'blue', legend = 'TIME B', box.col = 'blue', border = 'blue', fill = 'blue', cex = 1.2)
dev.off()
...
jogo1ime <- read.delim("~/Development/IME/cea2/CEA2/jogo3acao.txt", header=TRUE)
jogo1ime <- na.omit(jogo1ime)
...
# mudar aqui dependendo do jogo
ataque_posseEB[1:4] <- 0
jogo1ime_escalado <- cbind(jogo1ime_escalado, ataque_posseEA, ataque_posseEB)
...
png('~/Development/IME/cea2/CEA2/descritiva/area_poligono_fossa/j3.png',
    width = 700, height = 448)
#mudar aqui dependendo do jogo
plot(AA~tempo, xlim = c(0, nrow(jogo1ime_escalado)), data = jogo1ime[1,], 
     col = 'red', lty=0, type = 'l', ylab = 'Área do Polígono',
...
legend(8, 2035, col = 'red', legend = 'TIME A', box.col = 'red', border = 'red', fill = 'red', cex = 1.2)
legend(8, 1845, col = 'blue', legend = 'TIME B', box.col = 'blue', border = 'blue', fill = 'blue', cex = 1.2)
dev.off()
...
jogo1ime <- read.delim("~/Development/IME/cea2/CEA2/jogo4acao.txt", header=TRUE)
jogo1ime <- na.omit(jogo1ime)
...
png('~/Development/IME/cea2/CEA2/descritiva/area_poligono_fossa/j4.png',
    width = 700, height = 448)
#mudar aqui dependendo do jogo
plot(AA~tempo, xlim = c(0, nrow(jogo1ime_escalado)), data = jogo1ime[1,], 
     col = 'red', lty=0, type = 'l', ylab = 'Área do Polígono',
...
legend(3, 2035, col = 'red', legend = 'TIME A', box.col = 'red', border = 'red', fill = 'red', cex = 1.2)
legend(3, 1845, col = 'blue', legend = 'TIME B', box.col = 'blue', border = 'blue', fill = 'blue', cex = 1.2)
dev.off()
...
jogo1ime <- read.delim("~/Development/IME/cea2/CEA2/jogo5acao.txt", header=TRUE)
jogo1ime <- na.omit(jogo1ime)
...
#mudar aqui dependendo do jogo
png('~/Development/IME/cea2/CEA2/descritiva/area_poligono_fossa/j5.png',
    width = 700, height = 448)
#mudar aqui dependendo do jogo
plot(AA~tempo, xlim = c(0, nrow(jogo1ime_escalado)), data = jogo1ime[1,], 
     col = 'red', lty=0, type = 'l', ylab = 'Área do Polígono',
     xlab = 'Tempo', ylim = c(400, 3000), 
     cex.lab=1.4, cex.axis = 1.3)
tempo <- 1
abline(v=tempo, lty = 3, col = 'blue')
text(x=tempo, y=3000, labels = sprintf('B%s',
                                       ataque[tempo]), col='blue', cex=1.2)
linha_EA <- 1
linha_EB <- 1
...
for(tempo in jogo1ime_escalado$tempo[2:nrow(jogo1ime_escalado)]){
  ...
  if(ataque_posseEA[tempo] != ataque_posseEA[tempo-1]){
    ...
    text(x=tempo, y=450, labels = sprintf('d%s',
                                          desf_ataque[tempo]), col='blue',cex=1.2)
    text(x=tempo, y=3000, labels = sprintf('A%s',
                                           ataque[tempo]), col='red', cex=1.2)
  }
...
legend(22, 2900, col = 'red', legend = 'TIME A', box.col = 'red', border = 'red', fill = 'red', cex = 1.2)
legend(22, 2600, col = 'blue', legend = 'TIME B', box.col = 'blue', border = 'blue', fill = 'blue', cex = 1.2)
dev.off()
